"""Tests for longitudinal endpoint registration and metadata."""

from omninexu.api.endpoints.longitudinal import register
from omninexu.api.endpoints.longitudinal.bazaar import BAZAAR_EXTENSION, ENDPOINT_META
