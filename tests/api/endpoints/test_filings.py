"""Tests for filings endpoint registration and metadata."""

from omninexu.api.endpoints.filings import register
from omninexu.api.endpoints.filings.bazaar import BAZAAR_EXTENSION, ENDPOINT_META
