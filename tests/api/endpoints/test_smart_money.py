"""Tests for smart_money endpoint registration and metadata."""

from omninexu.api.endpoints.smart_money import register
from omninexu.api.endpoints.smart_money.bazaar import BAZAAR_EXTENSION, ENDPOINT_META
