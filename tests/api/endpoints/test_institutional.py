"""Tests for institutional endpoint registration and metadata."""

from omninexu.api.endpoints.institutional import register
from omninexu.api.endpoints.institutional.bazaar import BAZAAR_EXTENSION, ENDPOINT_META
