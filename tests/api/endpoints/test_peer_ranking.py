"""Tests for peer_ranking endpoint registration and metadata."""

from omninexu.api.endpoints.peer_ranking import register
from omninexu.api.endpoints.peer_ranking.bazaar import BAZAAR_EXTENSION, ENDPOINT_META
